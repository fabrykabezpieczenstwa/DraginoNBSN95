...
## 1. Pobranie środowiska programistycznego Arm Keil uVision5
...
## 4. Konfiguracja "Options for Target"
  1. W programie Arm Keil uVision5 wybierz "Options for Targets"
  2. W zakładce "Device" upewnij się że jest wybrane odpowiednie urządzenie: 
     STMicroelectronics → STM32L0 Series → STM32L072CZTx
  3. W zakładce "Target" w polu "Code generation" wybierz  "ARM Compiler" z listy: V5.06 Update 7 (build 960)
  4. W zakładce "Output" upewnij się, że zaznaczone jest pole "Create HEX File"
  5. W zakładce User upewnij śię, że w polu "After Build" → "Run #1" jest wybrana odpowiednia ścieżka do pliku fromelf.exe np.:
